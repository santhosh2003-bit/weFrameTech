...
type CardData = FirstCard | SecondCard;
const Section = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const jsonData: CardData[] = await response.json();
        setData(jsonData);
      } catch (error) {
  ...
  return (
    <div className="grid grid-cols-3 gap-5 mt-[70px]">
      {data &&
        data.map((data: CardData) => (
          <div
            className="rounded-tl-[30px] rounded-tr-[0px] rounded-br-[30px] rounded-bl-[0px] border-2 flex flex-col gap-3 border-[rgba(40,227,233,1)] w-[310px] overflow-hidden h-fit "
            key={data.id}
          >
            {"Mango" in data ? (
              <div className="w-full pt-[20px] pr-[20px] pl-[20px]">
                <div className="flex items-center gap-1 bg-[rgba(161,12,12,0.05)] py-[3px] px-[12px] rounded-[30px] w-fit ">
                  <div className="w-[4px] h-[4px] rounded-full bg-[rgba(161,12,12,1)]"></div>
                  <h2 className="font-[Sora] font-light text-[12px] leading-[15.12px] tracking-[1%] text-[rgba(161,12,12,1)]">
                    nicht lieferbar
                  </h2>
                </div>
              </div>
            ) : (
              <div className="w-full pt-[20px] pr-[20px] pl-[20px] flex justify-between">
                <div className="flex items-center gap-1 bg-[rgba(13,112,82,0.05)] py-[3px] px-[12px] rounded-[30px] w-fit ">
                  <div className="w-[4px] h-[4px] rounded-full bg-[rgba(13,112,82,1)]"></div>
                  <h2 className="font-[Sora] font-light text-[12px] leading-[15.12px] tracking-[1%] text-[rgba(13,112,82,1)]">
                    sofort lieferbar
                  </h2>
                </div>
                <div className="flex items-center gap-1 bg-[rgba(98,195,198,0.1)] py-[3px] px-[12px] rounded-[30px] w-fit ">
                  <h2 className="font-[Sora] font-light text-[12px] leading-[15.12px] tracking-[1%] text-[rgba(17,106,108,1)]">
                    Neu
                  </h2>
                </div>
              </div>
            ...
            <div className="p-6 border-2 flex flex-col gap-[30px] border-[rgba(40,227,233,1)] bg-[rgba(98,195,198,0.3)] shadow-[0px_0px_10px_0px_rgba(7,64,64,0.1)]">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-4">
                    <div className="rounded-[4px] border-b-2 pt-[4px] pr-[10px] pl-[10px] pb-[2px] gap-[10px] bg-[rgba(98,195,198,0.3)] w-fit">
                      <h2 className="font-[Sora] font-semibold text-[16px] leading-[20.16px] tracking-[1%] text-[rgba(54,87,88,1)]">
                        Canify
                      </h2>
                    </div>
                    <div className="flex gap-3 items-center">
                      <div className="bg-[rgba(252,252,250,1)] rounded-[4px] pt-[4px] pr-[16px] pb-[4px] pl-[16px]">
                        <h2 className="font-[Sora] font-normal text-[15px] leading-[20.16px]  text-[rgba(17,106,108,1)]">
                          {data.THC}
                        </h2>
                      </div>
                      <div className="bg-[rgba(98,195,198,1)] rounded-[4px] pt-[4px] pr-[16px] pb-[4px] pl-[16px]">
                        <h2 className="font-[Sora] font-normal text-[16px] leading-[20.16px]  text-[rgba(252,252,250,1)]">
                          CBD {"<"} 1%{" "}
                        </h2>
                      </div>
                      <svg
                  ...
                  <h2 className="font-[Sora] font-semibold text-[18px] leading-[22.68px] tracking-[1%] text-[rgba(17,106,108,1)]">
                    Cannabis Flos 18/1 PT Mango
                  </h2>
                </div>
                <div>
                  <div className="flex items-center justify-between border-b border-dashed border-b-[rgba(98,195,198,0.3)]">
                    <h2 className="font-[Sora] font-normal text-[16px] leading-[20.16px]  text-[rgba(54,87,88,1)] ">
                      Kultivar
                    </h2>

                    <h2 className="font-[Sora] font-normal text-[15px] leading-[20.16px]  text-[rgba(54,87,88,1)]">
                      {"Mango" in data ? data.Mango : data.Pink}
                    </h2>
                  </div>
                  <div className="flex items-center justify-between border-b border-dashed border-b-[rgba(98,195,198,0.3)]">
                    <h2 className="font-[Sora] font-normal text-[16px] leading-[20.16px]  text-[rgba(54,87,88,1)]">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-[2px]">
                    <h1 className=" font-extrabold text-[24px] leading-[30.24px]  text-[rgba(98,195,198,1)]">
                      €
                    </h1>
                    <h1 className="font-extrabold text-[24px] leading-[30.24px]  text-[rgba(17,106,108,1)]">
                      11,66
                      <sup className=" font-bold text-[13px] leading-[23.87px] tracking-[1%]">
                        1
                      </sup>
                    </h1>
                  </div>
                  <p className="font-[Sora] font-light text-[12px] leading-[15.12px] tracking-[1%] text-[rgba(54,87,88,1)]">
                    pro Gramm
                  </p>
                </div>
                <button className="font-[Sora] font-normal text-[14px] leading-[17.64px] tracking-[1%] text-[rgba(54,87,88,1)] rounded-tl-[24px] rounded-tr-[0px] rounded-br-[24px] rounded-bl-[0px] pt-[7px] pr-[18px] pb-[8px] pl-[18px] bg-[rgba(236,254,170,1)]">
                  in den Warenkorb
                </button>
              </div>
            </div>
